...
with open("D:/tesis/Model_neighbors/X4_ABM/_0_4_dw_gain_grid.txt", "w") as file:
    file.write(str(grid_info))

with open("D:/tesis/Model_neighbors/X4_ABM/_0_4_dw_gain_cars.txt", "w") as file:
