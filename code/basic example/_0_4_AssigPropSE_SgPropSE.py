...
asignacion de gain de carros por SE y Sg inicializado con SE
@author: Angelica
"""
...
with open("D:/tesis/Model_neighbors/lexicografico_menos/lexico_rd_grid_4.txt", "w") as file:
    file.write(str(grid_info))


with open("D:/tesis/Model_neighbors/lexicografico_menos/lexico_rd_cars_4.txt", "w") as file:
