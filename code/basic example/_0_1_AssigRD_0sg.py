...
asignacion de carros aleatorioa y Sg inicializado en cero
@author: Angelica
"""
...
# import info neighborhoodsD:\tesis\Model_neighbors\lexicografico_menos
...
with open("D:/tesis/Model_neighbors/lexicografico_menos/lexico_rd_grid.txt", "w") as file:
    file.write(str(grid_info))

with open("D:/tesis/Model_neighbors/lexicografico_menos/lexico_rd_cars.txt", "w") as file:
